        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: true),
                    PreferredRange = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeasurementDefinitions_Plants_PlantId",
                        column: x => x.PlantId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    MeasurementDefinitionId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Measurements_MeasurementDefinitions_MeasurementDefinitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAdvices", x => new { x.AdviceId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserAdvices_Advices_AdviceId",
                        column: x => x.AdviceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Boards_Dashboards_DashboardId",
                        column: x => x.DashboardId,
                        principalTable: "Dashboards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Boards_Plants_PlantId",
                        column: x => x.PlantId,
                        principalTable: "Plants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advices_TagId",
                table: "Advices",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_Boards_DashboardId",
                table: "Boards",
                column: "DashboardId");

            migrationBuilder.CreateIndex(
                name: "IX_Boards_PlantId",
                table: "Boards",
                column: "PlantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeasurementDefinitions_PlantId",
                table: "MeasurementDefinitions",
                column: "PlantId");

            migrationBuilder.CreateIndex(
                name: "IX_Measurements_MeasurementDefinitionId",
                table: "Measurements",
